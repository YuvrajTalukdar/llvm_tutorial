...
define dso_local noundef i32 @_Z4foo1i(i32 noundef %0) local_unnamed_addr #0 {
  %2 = add nsw i32 %0, 1
  ret i32 %2
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind sspstrong willreturn memory(none) uwtable
define dso_local noundef i32 @_Z4foo2ii(i32 noundef %0, i32 noundef %1) local_unnamed_addr #0 {
  %3 = icmp sgt i32 %1, 0
  %4 = add nsw i32 %1, -1
  %5 = add nuw i32 %1, 1
  %6 = mul i32 %4, %5
